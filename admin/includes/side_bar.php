  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <li>
            <a href="account.php?user=teacher">
              <i class="bi bi-circle"></i><span>teacher</span>
            </a>
          </li>
          <li>
            <a href="account.php?user=student">
              <i class="bi bi-circle"></i><span>student</span>
            </a>
          </li>
          <li>
            <a href="account.php?user=parent">
              <i class="bi bi-circle"></i><span>parent</span>
            </a>
          </li>
          <li>
            <a href="account.php?user=admin">
